...
var I, h, error, exact;
class Trapezoidal_Rule extends Component {
    constructor() {
        super();
        this.state = {
            fx: "",
    ...
    databaseAPI = async()=>{
        var response = await axios.get('http://localhost:3010/api/users/showTrap').then(res => {return res.data});
        this.setState({
        ...
        alert(this.state.a)
        alert(this.state.b)
        this.Trapezoidal_Rule(this.state.a,this.state.b);
    }
    Trapezoidal_Rule(a, b) {
        h = (b-a)/2 ; 
        I = h*(this.func(a) + this.func(b))
    ...
    render() {
        return(
            ...
            <div>
                ...
                <span style={{ color: 'Black', fontSize: '24px' }}>Trapezoidal Rule's</span>
                <br></br><br></br>
                    <Card
                    ...
                    >
                        {this.state.showinput &&
                            <div>
                                ...
                                <Button type="primary" size="large" onClick= {()=>this.Trapezoidal_Rule(parseFloat(this.state.a), parseFloat(this.state.b))}>Submit</Button><br></br><br></br>
...
export default Trapezoidal_Rule;