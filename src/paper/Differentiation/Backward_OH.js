...
var y, error, exact;
class Backward_OH extends Component {
    constructor() {
        super();
        this.state = {
            fx: "",
    ...
    databaseAPI = async()=>{
        ...
        alert(this.state.x)
        alert(this.state.h)
        this.Backward_OH(this.state.x,this.state.h,this.state.Order);
    }
    Backward_OH(x, h, degree) {
        switch (degree) {
            case 1:
    ...
    render() {
        return(
            ...
            <div>
                ...
                <span style={{ color: 'Black', fontSize: '24px' }}>Backward Divided-Difference O(h)</span>
                <br></br><br></br>
                    <Card
                    ...
                    >
                        {this.state.showinput &&
                            <div>
                                ...
                                <Button type="primary" size="large" onClick= {()=>this.Backward_OH(parseFloat(this.state.x), parseFloat(this.state.h), parseInt(this.state.degree))}>Submit</Button><br></br><br></br>
